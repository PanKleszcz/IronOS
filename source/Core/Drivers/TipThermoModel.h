...
public:
  ...
  static TemperatureType_t getTipInCx10(bool sampleNow = false);
  ...
  static TemperatureType_t convertTipRawADCToDegCx10(uint16_t rawADC);
...
private:
  static TemperatureType_t convertuVToDegC(uint32_t tipuVDelta) { return convertuVToDegCx10(tipuVDelta)/10; }
  static TemperatureType_t convertuVToDegCx10(uint32_t tipuVDelta);
